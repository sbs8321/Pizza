...
import c_Service.adminreservationUpdateyesService;
import f_vo.ActionForward;

public class adminreservationUpdateyes implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		adminreservationUpdateyesService adminreservationupdateyes =new adminreservationUpdateyesService();
		
		Result = adminreservationupdateyes.yes(num,id);
