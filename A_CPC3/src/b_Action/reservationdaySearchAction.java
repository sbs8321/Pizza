...
import c_Service.searchdayService;
import f_vo.ActionForward;
import f_vo.PageInfo;
import f_vo.reservation;

public class reservationdaySearchAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		pageinfo.setStartPage(startPage);
	 	...
	 	searchdayService searchdayservice = new searchdayService();
		ArrayList<reservation> resList = searchdayservice.search(search,page,limit);
